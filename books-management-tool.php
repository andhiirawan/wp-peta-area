 ...
 *
 * @link              https://andhiirawan.my.id/
 * @since             1.0.0
 * @package           Books_Management_Tool
 *
 * @wordpress-plugin
 * Plugin Name:       Peta Management Tool
 * Plugin URI:        https://andhiirawan.my.id/
 * Description:       This is a custom plugin that can check whether an address is inside or outside of the service area in Google Map.
 * Version:           1.0.0
 * Author:            Andhi Irawan
 * Author URI:        https://andhiirawan.my.id/
 * License:           GPL-2.0+
