...
class Books_Management_Tool_Admin {
	...
	public function book_management_menu(){
		...
		add_menu_page("Peta Management Tool", "Peta Management Tool", "manage_options", "book-management-tool", array($this, "book_management_plugin"), "
dashicons-admin-site-alt3", 22);
    ...
    // create plugin submenus
		...
		add_submenu_page("book-management-tool","Create Peta Shelf", "Create Peta Shelf", "manage_options", "book-management-create-book-shelf", array($this, "book_management_create_book_shelf"));

		add_submenu_page("book-management-tool","List Peta Shelf", "List Peta Shelf", "manage_options", "book-management-list-book-shelf", array($this, "book_management_list_book_shelf"));

		add_submenu_page("book-management-tool","Create Peta", "Create Peta", "manage_options", "book-management-create-book", array($this, "book_management_create_book"));

		add_submenu_page("book-management-tool","List Peta", "List Peta", "manage_options", "book-management-list-book", array($this, "book_management_list_book"));
	}
